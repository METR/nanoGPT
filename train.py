...
min_lr = 0.001 # minimum learning rate, should be ~= learning_rate/10 per Chinchilla
# DDP settings
...
mu_parameterization = True # whether to use the mu parameterization
# -----------------------------------------------------------------------------
...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  bias=bias, vocab_size=None, dropout=dropout, mu_parameterization=mu_parameterization) # start with model_args from command line
if init_from == 'scratch':
    ...
    for k in ['n_layer', 'n_head', 'n_embd', 'block_size', 'bias', 'vocab_size', 'mu_parameterization']:
